...
document.addEventListener("DOMContentLoaded", function () {
    ...
    const modalBody = document.querySelector(".tarjeta-container");
    ...
    const categorias = {
        "Escolares": [
            { nombre: "Crayones", img: "./images/Categorias/escolares.PNG" },
            { nombre: "Lápices", img: "./images/Categorias/escolares.PNG" },
            { nombre: "Gomas", img: "./images/Categorias/escolares.PNG" },
            { nombre: "Cuadernos", img: "./images/Categorias/escolares.PNG" }
        ],
        "Oficina": [
            { nombre: "Folders", img: "./images/Categorias/oficina.PNG" },
            { nombre: "Engrapadoras", img: "./images/Categorias/oficina.PNG" },
            { nombre: "Notas adhesivas", img: "./images/Categorias/oficina.PNG" }
        ],
        "Manualidades": [
            { nombre: "Pinturas", img: "./images/Categorias/manualidades.JPG" },
            { nombre: "Pinceles", img: "./images/Categorias/manualidades.JPG" },
            { nombre: "Foamy", img: "./images/Categorias/manualidades.JPG" }
        ],
        "Y más": [
            { nombre: "Globos", img: "./images/Categorias/mas.PNG" },
            { nombre: "Tarjetas", img: "./images/Categorias/mas.PNG" },
            { nombre: "Decoraciones", img: "./images/Categorias/mas.PNG" }
        ]
    };

    // Evento para abrir el modal al hacer clic en una categoría
    document.querySelectorAll(".categoria").forEach(item => {
        item.addEventListener("click", function () {
            let categoria = this.querySelector(".main-container").textContent.trim();
            modalTitle.textContent = categoria;
            modalBody.innerHTML = ""; // Limpia el contenido anterior

            // Agrega tarjetas dinámicamente con imagen y texto
    ...
    btnEnviar.addEventListener("click", function () {
        alert("¡Productos enviados con éxito! 🚀");
    });
});
